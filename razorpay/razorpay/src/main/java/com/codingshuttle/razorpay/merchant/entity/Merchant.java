...
public class Merchant {
    ...
    private BusinessType businessType; // enum field // created enum for businessName
    ...
    @Enumerated(EnumType.STRING)
    private MerchantStatus status = MerchantStatus.PENDING_KYC; // enum field // created enum for MerchantStatus
